    ...
    return (
      <article className="team-member">
        ...
        <article className="about-description">
          ...
          <br /> <br />
          At 2012 I joined the IDF inteligence force. During those years I broke
          the swimming national records and represented Israel in European and
          World championships and 2016 Rio Olympic games.
          <br />
          <br />
